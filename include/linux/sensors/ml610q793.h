...
#define    ACCSNS_ACTIVE_TAPDETECT  0x4000
...
#define    ACCSNS_ACTIVE_TAPDETECT_ERROR  (ACCSNS_ACTIVE_TAPDETECT >> 4)
#define    ACTIVE_FUNC_MASK    (ACCSNS_ACTIVE_ACC | ACCSNS_ACTIVE_PEDOM | ACCSNS_ACTIVE_VEHICLE | ACCSNS_ACTIVE_IWIFI | ACCSNS_ACTIVE_TAPDETECT)
#define    ACCSNS_ACTIVE_ERROR (ACCSNS_ACTIVE_PEDOM_ERROR | ACCSNS_ACTIVE_VEHICLE_ERROR | ACCSNS_ACTIVE_IWIFI_ERROR)

#define    ACCSNS_TD_NONE             0x00
#define    ACCSNS_TD_LIKE             0x01
#define    ACCSNS_TD_DETERMINE        0x02
#define    ACCSNS_TD_NOT_DET          0x04
#define    ACCSNS_TD_ERROR            0xFF
...
#define    DAILYS_CLEAR_RT_STATE      0x80
...
#define    TAPDET_CLEAR_TAP_STATE     0x01
...
typedef struct {
  ...
  uint32_t m_iSyncRunStepCnt;
  uint32_t m_iSyncRunTime;
  uint32_t m_iSyncRunCal;
  uint32_t m_iRunCal;
