...
#define PIXART_TOUCH_NUMBER_GEN1			4
#define PIXART_TOUCH_NUMBER_GEN2			10
...
#define CTP_ROWS			12
#define CTP_COLS			20
#define AMRI5K_FORCE_MAX	20
#define AMRI5K_AREA_MAX		20
#define AMRI5K_MAX_PRESSURE	2550
#define Y_MAX				272
...
struct pixart_touch_data_gen1 {
	uint8_t status;
	uint8_t total_touch;
	struct pixart_point_data point_data[PIXART_TOUCH_NUMBER_GEN1];
};

struct pixart_touch_data_gen2 {
	uint8_t status;
	uint8_t total_touch;
	struct pixart_point_data point_data[PIXART_TOUCH_NUMBER_GEN2];
	uint8_t slot_id[10];
};
#pragma pack()
