...
static struct gpiomux_setting atmel_resout_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting atmel_int_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
...
static struct msm_gpiomux_config msm_touch_configs[] __initdata = {
	{
		.gpio      = 60,		/* TOUCH RESET */
		.settings = {
			[GPIOMUX_ACTIVE] = &atmel_resout_cfg,
			[GPIOMUX_SUSPENDED] = &atmel_resout_cfg,
		},
	},
	{
		.gpio      = 61,		/* TOUCH IRQ */
		.settings = {
			[GPIOMUX_ACTIVE] = &atmel_int_cfg,
			[GPIOMUX_SUSPENDED] = &atmel_int_cfg,
		},
	},
...
void __init msm_8974_init_gpiomux(void)
{
    ...
    if (socinfo_get_version() >= 0x20000) {
        msm_tlmm_misc_reg_write(TLMM_SPARE_REG, 0x5); // GPIO 15 and 17
    }
    else {
