...
static struct clk_freq_tbl ftbl_gcc_blsp1_2_qup1_6_spi_apps_clk[] = {
	F(  960000,    cxo,  10,   1,   2),
	F( 1792000,  gpll0,  10,   2,  67), /* 1.791044776 Mhz */ 
	F( 4800000,    cxo,   4,   0,   0),
	F( 9600000,    cxo,   2,   0,   0),
	F(15000000,  gpll0,  10,   1,   4),
	F(19200000,    cxo,   1,   0,   0),
	F(25000000,  gpll0,  12,   1,   2),
	F(48000000,  gpll0,   1,   2,  25),
...
static struct clk_freq_tbl ftbl_gcc_sdcc2_apps_clk[] = {
	F(   144000,    cxo,  16,   3,  25),
	F(   384000,    cxo,  12.5,   1,   4),
	F( 20000000,  gpll0,  15,   1,   2),
	F( 24000000,  gpll0,  12.5,   1,   2),
	F( 48000000,  gpll0,  12.5,   0,   0),
	F( 96000000,  gpll0,   1,   4,   25),
	F(200000000,  gpll0,   3,   0,   0),
	F_END
};
...
static struct clk_lookup msm_clocks_8974[] = {
	...
	/* MM sensor clocks */
	CLK_LOOKUP("cam_src_clk", mmss_gp0_clk_src.c, "c0.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6e.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "20.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", gp1_clk_src.c, "7a.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "90.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_gp0_clk.c, "c0.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6e.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "20.qcom,camera"),
	CLK_LOOKUP("cam_clk", gcc_gp1_clk.c, "7a.qcom,camera"),
