...
enum {
    ...
    SMEM_UICC_INFO               = SMEM_KCC_BASE + 2,
    SMEM_KERR_LOG                = SMEM_KCC_BASE + 3,
    SMEM_CRASH_LOG               = SMEM_KCC_BASE + 4,
    SMEM_FACTORY_CMDLINE         = SMEM_KCC_BASE + 5,
    SMEM_FACTORY_USB             = SMEM_KCC_BASE + 6,
    SMEM_FACTORY_OPTIONS         = SMEM_KCC_BASE + 7,
    SMEM_DDR_DATA_INFO           = SMEM_KCC_BASE + 8,
    SMEM_KC_WM_UUID              = SMEM_KCC_BASE + 9,
    SMEM_SECUREBOOT_FLAG         = SMEM_KCC_BASE + 10,
    SMEM_SBL1_BOOTVER            = SMEM_KCC_BASE + 11,
    SMEM_BFSS_DATA               = SMEM_KCC_BASE + 12,
    SMEM_KC_POWER_ON_STATUS_INFO = SMEM_KCC_BASE + 13,
    SMEM_FASTBOOT_FLAG           = SMEM_KCC_BASE + 14,
    SMEM_BOOT_PW_ON_CHECK        = SMEM_KCC_BASE + 15,
};
