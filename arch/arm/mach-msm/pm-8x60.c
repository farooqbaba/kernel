...
#include <mach/gpio.h>
#define GPIO51_SLEEP_SETTING \
   GPIO_CFG(51, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA)
#define GPIO52_SLEEP_SETTING \
   GPIO_CFG(52, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA)
#define GPIO101_SLEEP_SETTING \
   GPIO_CFG(101,0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)

#define GPIO51_ACTIVE_SETTING \
   GPIO_CFG(51, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
#define GPIO52_ACTIVE_SETTING \
   GPIO_CFG(52, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
#define GPIO101_ACTIVE_SETTING \
...
static bool msm_pm_power_collapse(bool from_idle)
{
    ...
    if(0 == cpu){
        gpio_tlmm_config( GPIO51_SLEEP_SETTING, GPIO_CFG_ENABLE );
        gpio_tlmm_config( GPIO52_SLEEP_SETTING, GPIO_CFG_ENABLE );
        gpio_tlmm_config( GPIO101_SLEEP_SETTING, GPIO_CFG_ENABLE );
    }
    ...
    if(0 == cpu){
        gpio_tlmm_config( GPIO51_ACTIVE_SETTING, GPIO_CFG_ENABLE );
        gpio_tlmm_config( GPIO52_ACTIVE_SETTING, GPIO_CFG_ENABLE );
        gpio_tlmm_config( GPIO101_ACTIVE_SETTING, GPIO_CFG_ENABLE );
    }
