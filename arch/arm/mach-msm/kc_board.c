...
#define     BOARD_CHECK1_NUM        96
#define     BOARD_CHECK2_NUM        95
...
static oem_board_type _board_type = OEM_BOARD0_TYPE;
...
void OEM_board_judgement(void)
{
  ...
  switch( _port_mask ){
    ...
    case PORT_MASK_HLL:
       _board_type = OEM_BOARD4_TYPE;

       gpio_tlmm_config( BOARD_CHECK1_NO_PULL, GPIO_CFG_ENABLE );
       break;
       
    case PORT_MASK_HLH:
       _board_type = OEM_BOARD5_TYPE;
