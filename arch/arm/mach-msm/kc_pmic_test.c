...
#define PM8841_VREG_SMPS_NUM	8  /* PM8841 VREG SMPS Number */

#define PM8941_VREG_LDO_NUM	24 /* PM8941 VREG LDO Number */
#define PM8941_VREG_SMPS_NUM	3  /* PM8941 VREG SMPS Number */
#define PM8941_VREG_VS_NUM	5  /* PM8941 VREG VS Number  */
#define PM8941_VREG_BOOST_NUM	1  /* PM8941 VREG BOOST Number  */

#define PM_VREG_LDO_NUM		PM8941_VREG_LDO_NUM
#define PM_VREG_SMPS_NUM	(PM8841_VREG_SMPS_NUM + PM8941_VREG_SMPS_NUM)
#define PM_VREG_VS_NUM		PM8941_VREG_VS_NUM
#define PM_VREG_BOOST_NUM	PM8941_VREG_BOOST_NUM
...
static const char *pin_type[4]
	= { "msm-gpio", "pm8941-gpio", "pm8941-mpp", "pm8941-mpp"};
...
vreg_setting_data vreg_data[PM_VREG_MAX_NUM] = {
	...
	/* PM8841 */
	{"8841_s1",	PMIC_VREG_SMPS,   500000, 1400000}, /* SMPS_1   */
	{"8841_s2",	PMIC_VREG_SMPS,   500000, 1250000}, /* SMPS_2   */
	{"8841_s3",	PMIC_VREG_SMPS,   500000, 1400000}, /* SMPS_3   */
	{"8841_s4",	PMIC_VREG_SMPS,   500000, 1250000}, /* SMPS_4   */
	{"krait0",	PMIC_VREG_SMPS,   500000, 1250000}, /* KRAIT_0  */
	{"krait1",	PMIC_VREG_SMPS,   500000, 1250000}, /* KRAIT_1  */
	{"krait2",	PMIC_VREG_SMPS,   500000, 1250000}, /* KRAIT_2  */
	{"krait3",	PMIC_VREG_SMPS,   500000, 1250000}, /* KRAIT_3  */
	/* PM8941 */
	{"8941_s1",	PMIC_VREG_SMPS,  1200000, 1500000}, /* SMPS_1   */
	{"8941_s2",	PMIC_VREG_SMPS,  1800000, 2250000}, /* SMPS_2   */
	{"8941_s3",	PMIC_VREG_SMPS,  1750000, 1850000}, /* SMPS_3   */
	{"8941_l1",	PMIC_VREG_LDO,   1200000, 1250000}, /* LDO_L1   */
	{"8941_l2",	PMIC_VREG_LDO,   1100000, 1450000}, /* LDO_L2   */
	{"8941_l3",	PMIC_VREG_LDO,   1100000, 1450000}, /* LDO_L3   */
	{"8941_l4",	PMIC_VREG_LDO,   1150000, 1400000}, /* LDO_L4   */
	{"8941_l5",	PMIC_VREG_LDO,   1700000, 2200000}, /* LDO_L5   */
	{"8941_l6",	PMIC_VREG_LDO,   1700000, 1900000}, /* LDO_L6   */
	{"8941_l7",	PMIC_VREG_LDO,   1700000, 2200000}, /* LDO_L7   */
	{"8941_l8",	PMIC_VREG_LDO,   1700000, 1900000}, /* LDO_L8   */
	{"8941_l9",	PMIC_VREG_LDO,   1700000, 3050000}, /* LDO_L9   */
	{"8941_l10",	PMIC_VREG_LDO,   1700000, 3050000}, /* LDO_L10  */
	{"8941_l11",	PMIC_VREG_LDO,   1200000, 1400000}, /* LDO_L11  */
	{"8941_l12",	PMIC_VREG_LDO,   1700000, 1900000}, /* LDO_L12  */
	{"8941_l13",	PMIC_VREG_LDO,   2750000, 3000000}, /* LDO_L13  */
	{"8941_l14",	PMIC_VREG_LDO,   1700000, 2100000}, /* LDO_L14  */
	{"8941_l15",	PMIC_VREG_LDO,   2000000, 2100000}, /* LDO_L15  */
	{"8941_l16",	PMIC_VREG_LDO,   2600000, 3000000}, /* LDO_L16  */
	{"8941_l17",	PMIC_VREG_LDO,   2700000, 3000000}, /* LDO_L17  */
	{"8941_l18",	PMIC_VREG_LDO,   2400000, 2850000}, /* LDO_L18  */
	{"8941_l19",	PMIC_VREG_LDO,   2600000, 2850000}, /* LDO_L19  */
	{"8941_l20",	PMIC_VREG_LDO,   2750000, 2850000}, /* LDO_L20  */
	{"8941_l21",	PMIC_VREG_LDO,   2700000, 3000000}, /* LDO_L21  */
	{"8941_l22",	PMIC_VREG_LDO,   2600000, 3300000}, /* LDO_L22  */
	{"8941_l23",	PMIC_VREG_LDO,   2600000, 3300000}, /* LDO_L23  */
	{"8941_l24",	PMIC_VREG_LDO,   3000000, 3300000}, /* LDO_L24  */
	{"8941_lvs1",	PMIC_VREG_VS,          0,       0}, /* VS_LVS1  */
	{"8941_lvs2",	PMIC_VREG_VS,          0,       0}, /* VS_LVS2  */
	{"8941_lvs3",	PMIC_VREG_VS,          0,       0}, /* VS_LVS3  */
	{"8941_mvs1",	PMIC_VREG_VS,          0,       0}, /* VS_MVS1  */
	{"8941_mvs2",	PMIC_VREG_VS,          0,       0}, /* VS_MVS2  */
	{"8941_boost",	PMIC_VREG_BOOST, 4000000, 5500000}, /* 5V_BOOST */
};
