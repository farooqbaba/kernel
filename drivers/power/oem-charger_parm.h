...
#ifndef __OEM_CHARGER_PARM_H
#define __OEM_CHARGER_PARM_H
...
}oem_chg_param_cycles;

extern oem_chg_param_charger oem_param_charger;
extern oem_chg_param_hkadc oem_param_hkadc;
extern oem_chg_param_bms oem_param_bms;
extern oem_chg_param_share oem_param_share;
extern oem_chg_param_cycles oem_param_cycles;

void oem_chg_param_init(void);
void oem_param_cycles_backup(uint16_t, u8, int);
