...
static void extension_ram_log(int data_no, char *client_data)
{
...
#else  /*CONFIG_ANDROID_EXTENSION_RAM*/
#define extension_ram_log(data_no, client_data)     do { } while (0)
#endif /*CONFIG_ANDROID_EXTENSION_RAM*/
...
void extension_ram_log_update_time(void)
{
#ifdef CONFIG_ANDROID_EXTENSION_RAM
	unsigned long long cpu_sec;
	unsigned long  cpu_nanosec;
...
{
	extension_ram_log(EXTENSION_DATA_00,client_data);
}

void extension_ram_log_01(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_01,client_data);
}

void extension_ram_log_02(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_02,client_data);
}

void extension_ram_log_03(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_03,client_data);
}

void extension_ram_log_04(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_04,client_data);
}

void extension_ram_log_05(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_05,client_data);
}

void extension_ram_log_06(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_06,client_data);
}

void extension_ram_log_07(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_07,client_data);
}

void extension_ram_log_08(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_08,client_data);
}

void extension_ram_log_09(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_09,client_data);
}

void extension_ram_log_10(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_10,client_data);
}

void extension_ram_log_11(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_11,client_data);
}

void extension_ram_log_12(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_12,client_data);
}

void extension_ram_log_13(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_13,client_data);
}

void extension_ram_log_14(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_14,client_data);
}

void extension_ram_log_15(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_15,client_data);
}

void extension_ram_log_16(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_16,client_data);
}

void extension_ram_log_17(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_17,client_data);
}

void extension_ram_log_18(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_18,client_data);
}

void extension_ram_log_19(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_19,client_data);
}

void extension_ram_log_20(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_20,client_data);
}

void extension_ram_log_21(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_21,client_data);
}

void extension_ram_log_22(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_22,client_data);
}

void extension_ram_log_23(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_23,client_data);
}

void extension_ram_log_24(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_24,client_data);
}

void extension_ram_log_25(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_25,client_data);
}

void extension_ram_log_26(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_26,client_data);
}

void extension_ram_log_27(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_27,client_data);
}

void extension_ram_log_28(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_28,client_data);
}

void extension_ram_log_29(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_29,client_data);
}

void extension_ram_log_30(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_30,client_data);
}

void extension_ram_log_31(char *client_data)
{
	extension_ram_log(EXTENSION_DATA_31,client_data);
}
